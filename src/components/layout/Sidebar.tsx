...
const NAV_MODULOS: NavItem[] = [
  ...
  },
  {
    ...
    disponible: true,
    children: [
      { label: 'Resumen',    href: '/sii',            icon: null, disponible: true },
      { label: 'DTE',        href: '/sii/dte',         icon: null, disponible: true },
      { label: 'Honorarios', href: '/sii/honorarios',  icon: null, disponible: true },
      { label: 'F22 Renta',  href: '/sii/f22',         icon: null, disponible: true },
      { label: 'Config SII', href: '/sii/config',      icon: null, disponible: true },
    ],
    icon: (
      <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
