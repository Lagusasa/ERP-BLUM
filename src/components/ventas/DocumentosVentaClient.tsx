...
export default function DocumentosVentaClient({ documentos }: Props) {
      ...
      <div className="overflow-x-auto">
        <table className="w-full text-sm">
          ...
          <tbody className="divide-y divide-slate-100">
            {filtrados.length === 0 ? (
              <tr><td colSpan={7} className="text-center py-8 text-slate-400">No hay documentos que coincidan.</td></tr>
            ) : (
              filtrados.map((d) => (
